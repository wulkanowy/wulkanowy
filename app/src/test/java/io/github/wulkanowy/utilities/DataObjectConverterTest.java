...
public class DataObjectConverterTest {
    ...
    public void subjectConversionTest() {
        ...
        List<io.github.wulkanowy.database.dao.entities.Subject> subjectEntitiesList =
    ...
    public void gradesConversionTest() {
        ...
        List<io.github.wulkanowy.database.dao.entities.Grade> gradeEntitiesList =
    ...
    public void dayConversionTest() {
        ...
        List<io.github.wulkanowy.database.dao.entities.Day> dayEntityList =
    ...
    public void lessonConversionTest() {
        ...
        List<io.github.wulkanowy.database.dao.entities.Lesson> lessonEntityList =
