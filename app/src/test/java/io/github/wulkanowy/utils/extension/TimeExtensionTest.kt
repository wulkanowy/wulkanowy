...
class TimeExtensionTest {
    ...
    fun toFormat_LocalDateTime() {
        assertEquals("2018-10-01", LocalDateTime.of(2018, 10, 1, 10, 0, 0).toFormat())
        assertEquals("2018-10-01 10:00:00", LocalDateTime.of(2018, 10, 1, 10, 0, 0).toFormat("uuuu-MM-dd HH:mm:ss"))
    }
