...
class TimetableLocalTest {
    ...
    fun saveAndReadTest() {
        timetableDb.saveLessons(listOf(
                Timetable(studentId = "1", diaryId = "2", date = Date.valueOf("2018-09-10")),
                Timetable(studentId = "1", diaryId = "2", date = Date.valueOf("2018-09-14")),
                Timetable(studentId = "1", diaryId = "2", date = Date.valueOf("2018-09-17")) // in next week
        ))

        val exams = timetableDb
                .getLessons(Semester(studentId = "1", diaryId = "2", semesterId = "3"), LocalDate.of(2018, 9, 10))
                .blockingGet()
