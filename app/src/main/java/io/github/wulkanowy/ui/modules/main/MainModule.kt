...
import io.github.wulkanowy.ui.modules.about.creators.CreatorsModule
...
abstract class MainModule {
    ...
    @PerFragment
    @ContributesAndroidInjector(modules = [CreatorsModule::class])
    abstract fun bindCreatorsFragment(): CreatorsFragment
