...
class SentPresenter @Inject constructor(
    private val errorHandler: ErrorHandler,
    private val schedulers: SchedulersProvider,
    private val messagesRepository: MessagesRepository,
    private val studentRepository: StudentRepository
) : BasePresenter<SentView>(errorHandler) {

    override fun onAttachView(view: SentView) {
    ...
    fun onParentViewLoadData(forceRefresh: Boolean) {
        disposable.apply {
            ...
            add(studentRepository.getCurrentStudent()
                .flatMap { messagesRepository.getSentMessages(it.studentId, forceRefresh) }
                ...
                .subscribe({
                    ...
                    logEvent("Message sent load", mapOf("items" to it.size, "forceRefresh" to forceRefresh))
                }) {
