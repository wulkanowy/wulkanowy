        ...
        disposable.add(
            Single.fromCallable { if (loginData == null) throw IllegalArgumentException("Login data is null") else loginData }
                ...
                .subscribe({
                    ...
                    analytics.logEvent("registration_symbol", SUCCESS to false, "students" to -1, "scrapperBaseUrl" to loginData?.third, "symbol" to symbol, "error" to it.localizedMessage)
