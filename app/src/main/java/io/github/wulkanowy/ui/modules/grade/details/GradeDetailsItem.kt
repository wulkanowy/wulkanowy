...
class GradeDetailsItem(val grade: Grade, private val weightString: String, private val valueBgColor: Int, private val valueTextColor: Int) :
    ...
    override fun bindViewHolder(
        ...
        holder.run {
            gradeItemValue.run {
                ...
                setTextColor(ContextCompat.getColor(context, valueTextColor))
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (valueTextColor != other.valueTextColor) return false
