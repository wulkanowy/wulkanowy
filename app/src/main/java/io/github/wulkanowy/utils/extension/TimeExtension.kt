...
fun LocalDate.toFormat(format: String = DATE_PATTERN): String = this.format(DateTimeFormatter.ofPattern(format))

fun LocalDateTime.toFormat(format: String = DATE_PATTERN): String = this.format(DateTimeFormatter.ofPattern(format))
