...
fun Grade.getBackgroundColor(theme: String): Int {
    return when (theme) {
        ...
        "material" -> when (value) {
            6.0 -> R.color.grade_material_six
            5.0 -> R.color.grade_material_five
            4.0 -> R.color.grade_material_four
            3.0 -> R.color.grade_material_three
            2.0 -> R.color.grade_material_two
            1.0 -> R.color.grade_material_one
            else -> R.color.grade_material_default
        }
        else -> when (value) {
            6.0 -> R.color.grade_vulcan_six
            5.0 -> R.color.grade_vulcan_five
            4.0 -> R.color.grade_vulcan_four
            3.0 -> R.color.grade_vulcan_three
            2.0 -> R.color.grade_vulcan_two
            1.0 -> R.color.grade_vulcan_one
